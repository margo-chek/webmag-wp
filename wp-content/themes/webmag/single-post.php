					...
					<div class="col-md-8">
							...
							<div class="post-author">
								<div class="media">
									<div class="media-left">
										<img class="media-object" src="<?php echo get_template_directory_uri(); ?>/img/author.png" alt="">
									</div>
						...
						<div class="section-row">
							...
							<div class="post-comments">
								...
								<div class="media">
									<div class="media-left">
										<img class="media-object" src="<?php echo get_template_directory_uri(); ?>/img/avatar.png" alt="">
									</div>
									<div class="media-body">
										<div class="media-heading">
											<h4>John Doe</h4>
